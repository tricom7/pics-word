...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    CAT_PIC = [[NSArray alloc] initWithObjects:@"red", @"one", @"zebra", @"ladybug", @"grapes", @"corn", @"sandwich", @"juice", @"winter", @"January", @"father", @"T-shirt", @"hair", @"full", @"play", @"happy", @"sun", @"lightning", @"sofa", @"kettle", @"shop", @"north", @"roof", @"toilet paper", @"train", @"scissors", @"dice", @"model", @"triangle", nil];
